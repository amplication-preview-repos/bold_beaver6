...
using OrderManagementService.APIs.Dtos;
using OrderManagementService.APIs.Errors;
using OrderManagementService.APIs.Extensions;
...
{
    protected readonly OrderManagementServiceDbContext _context;

    public NotificationsServiceBase(OrderManagementServiceDbContext context)
    {
        _context = context;
    }
